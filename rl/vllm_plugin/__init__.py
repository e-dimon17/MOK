"""Out-of-tree vLLM registration of the MoK-MoE architecture.

    from rl.vllm_plugin import register_mok_moe
...
`rl.vllm_plugin.mok_moe_vllm` are pure and importable everywhere.
"""
