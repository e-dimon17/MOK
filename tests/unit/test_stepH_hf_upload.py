"""H/hf_upload.py — dry-run plan, model card rendering, fake-hub upload path."""
...
def test_render_model_card_fills_everything():
    ...
    assert "python -m H.replay_window" in card          # default replay instructions
    assert "python -m H.verify_bundle" in card
