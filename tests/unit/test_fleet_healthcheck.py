"""Tests for fleet/ops/healthcheck.py — canned probe outputs, assembly, CLI loop."""
...
from test_fleet_preflight import FakeUsage, topo_text

from fleet.ops.healthcheck import (
    HealthCheck,
    clock_sync,
    disk_space,
    gpu_health,
