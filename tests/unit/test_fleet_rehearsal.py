"""Tests for fleet/calibration/rehearsal.py — the full-protocol loopback dress
...
from fleet.calibration.rehearsal import CalibrationReport, run_calibration_windows
