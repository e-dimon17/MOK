"""SFT: DCP-checkpoint-contract -> HF conversion round-trip + parity gate.
...
from sft.convert_dcp_to_hf import (
    ConversionError,
    convert,
    infer_hf_config,
    load_dcp_state_dict,
...
from sft.verify_conversion import VerificationError, verify
