"""Tests for B/attestation/reference_step.py — the CPU attestation gate.
...
import B.attestation.reference_step as reference_step
from B.attestation.challenge import derive_expected, make_challenge
from B.attestation.reference_step import (
