"""SFT PARITY: mok_core reference model -> remap_state_dict -> HF model.

fp32 end-to-end (bf16 masters upcast exactly), logits must agree to 1e-4 —
the CPU twin of the release parity gate in sft/verify_conversion.py.
"""
...
from sft.convert_dcp_to_hf import ConversionError, remap_state_dict
