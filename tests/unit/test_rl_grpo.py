"""RL: grpo.yaml parsing, reward_router dispatch, TRL reward adapter."""
...
import rl.grpo_train as grpo_train
from rl.grpo_train import (
    GRPOSettings,
    VllmSettings,
    build_rlvr_dataset,
    endpoint_for_rank,
...
def test_load_settings_parses_shipped_yaml() -> None:
    settings = load_settings(REPO / "rl" / "configs" / "grpo.yaml")
