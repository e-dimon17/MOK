"""release/verify_bundle.py — content-level checks, signature hook, index shape, CLI."""
...
from test_release_provenance import build_fixture_bundle, make_audit, make_records, patch_bundle_file

import mok_core.chain as chain_mod
from release.provenance import INDEX_FILENAME, audit_report_message, canonical_bytes
from release.verify_bundle import build_parser, main, verify
