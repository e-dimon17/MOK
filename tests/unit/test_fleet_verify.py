"""Tests for fleet/attestation/verify.py — verdicts + the reattestation draw."""
...
from fleet.attestation.verify import AttestationVerdict, Verifier, judge, schedule_reattestation
