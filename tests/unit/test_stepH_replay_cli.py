"""H/replay_window.py — argument surface + monkeypatched replay path.

The heavy path (torch DCP load, C.core.replay.WindowReplayer) runs only on the
...
import pytest
from test_stepH_provenance import build_fixture_bundle, make_audit, make_manifest

from H import replay_window
from H.provenance import canonical_bytes
from H.replay_window import ReplayCLIError, build_parser, load_manifest_arg, main, report_to_dict
