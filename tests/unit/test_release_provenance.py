"""release/provenance.py — bundle build → verify round trip, tamper detection, goldens.

Also hosts the shared release-stage fixture builders (make_manifest / make_records /
make_audit / build_fixture_bundle) imported by the other test_release_* modules.
"""
...
from release import provenance
...
from release.verify_bundle import verify

# --------------------------------------------------------------------------- #
# Shared fixtures for all release-stage tests
# --------------------------------------------------------------------------- #
