...
(A/pipeline/build_manifest.py, A/pipeline/verify.py)."""
...
from A.pipeline.shard_writer import write_shards
from A.pipeline.verify import verify_local, verify_sample
