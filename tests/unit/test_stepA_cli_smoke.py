"""End-to-end `mok-data` CLI runs on fixture text — no network (A/cli.py)."""
...
from A.cli import main
from A.pipeline.build_manifest import MANIFEST_FILENAME, SHARD_INDEX_FILENAME, load_manifest_ref
from A.pipeline.download import spool_documents
