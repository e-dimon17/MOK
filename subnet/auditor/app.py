...
θ_start(w) in lockstep exactly like a miner (checkpoint restore + bitwise
  ...
  1. computes the consensus audit assignment (`subnet.core.replay.audit_sampler`)
  ...
  3. signs the verdict over its canonical unsigned fields and publishes it to
     ...
     subnet/miner/bootstrap.py); a wall-time budget guards multi-task windows
...
from subnet.core.exchange import ExchangeError, put_audit_report, put_telemetry
