"""The window runner — the full per-window protocol loop.
...
storage/chain/clock dependencies. `subnet.core.replay.WindowReplayer` calls THE
...
def run_training_phase(
    ...
    *,
    ...
    BYTES are deterministic. `subnet.core.replay` runs THE SAME function (with
...
class WindowRunner:
    ...
    this module. `self_leader=True` is the single-node bootstrap mode (fleet
