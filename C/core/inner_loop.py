...
(playbook step C): a fixed `WindowBatchPlan` drives every microbatch, a FRESH
...
from C.core.phase import PhaseConfig, accum_at, lr_at
from C.core.zero1 import Comm, Zero1Adam, flat_grad_all_reduce
