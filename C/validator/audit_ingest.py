...
Trust model (documented in C/miner/bootstrap.py): auditors advertise
...
(`C.core.replay.verify_report` + `chain.verify`); a report failing signature
...
from C.core.exchange import list_audit_reports
from C.core.replay import verify_report
from C.core.slashing import SlashLedger, SlashRecord
from C.miner.bootstrap import auditor_uids_from_chain
