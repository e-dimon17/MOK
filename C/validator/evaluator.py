...
θ_start(window):
  ...
  1. draws the miner's OWN pool (a subset of its assigned window data) and the
     ...
     `C.core.scoring.EvalPools` — both seeded by a post-commit block hash, so
...
from C.core.compress import TopKCompressor
from C.core.payload import WindowPayload
from C.core.phase import PhaseConfig
from C.core.pseudo_grad import CpuSnapshot, restore_and_extract_delta
from C.core.scoring import EvalPools, binary_indicator, gradient_score
from C.core.window_runner import DENSE_SUFFIX
from C.miner.bootstrap import NodeContext
