...
F/G, the provenance bundle from H/provenance.py) to a hub repo and writes a
...
python -m H.verify_bundle ./provenance
```
...
```bash
python -m H.replay_window --bundle ./provenance \\
