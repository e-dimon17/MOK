...
Layout (all paths relative to the bundle root)::
    ...
    replay/replay_window.py verbatim copy of H/replay_window.py

Byte rules (consensus surface of the release — golden-vector pinned in
tests/unit/test_stepH_provenance.py, any change is a bundle spec bump):
...
#: The AuditReport wire shape produced by C/core/replay.py (plan contract).
AUDIT_REPORT_FIELDS = (
    "miner_uid",
    "window",
    "theta_start_root",
