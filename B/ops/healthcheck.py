"""Periodic node health checks — the operator's watchdog (playbook step B).
...
from B.onboarding.preflight import parse_topo_matrix
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="python -m B.ops.healthcheck",
